...
const __1 = require("../../..");
const seller_model_1 = require("../../fixtures/models/seller.model");
...
describe('HasMany relation', () => {
    ...
    function givenConstrainedRepositories() {
        ...
        const sellerFactoryFn = __1.createHasManyThroughRepositoryFactory(Customer.definition.relations.sellers, __1.Getter.fromValue(sellerRepo), __1.Getter.fromValue(orderRepo));
...
function givenCrudRepositories() {
    ...
    sellerRepo = new __1.DefaultCrudRepository(seller_model_1.Seller, db);
}
